...
For each of the 3 list of stations that we reccomended, we then looked at the time distribution of passengers flow at stationsnoticing that it is not uniform in time, neither by weekday nor by hour ranges.  
